...
static inline void histogram_add( const uint16_t x[16], uint16_t y[16] )
{
    *(uint16x8_t*) &y[0] = vaddq_u16(*(uint16x8_t*) &y[0], *(uint16x8_t*) &x[0]);
...
static inline void histogram_muladd( const uint16_t a, const uint16_t x[16],
                                    uint16_t y[16] )
{
    *(uint16x8_t*) &y[0] = vmlaq_n_u16(*(uint16x8_t*) &y[0], *(uint16x8_t*) &x[0], a);
    *(uint16x8_t*) &y[8] = vmlaq_n_u16(*(uint16x8_t*) &y[8], *(uint16x8_t*) &x[8], a);
}
#else
static inline void histogram_muladd( const uint16_t a, const uint16_t x[16],
                                    uint16_t y[16] )
